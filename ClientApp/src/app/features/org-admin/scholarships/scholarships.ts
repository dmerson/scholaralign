        ...
        <table mat-table [dataSource]="[]" class="full-width">
          ...
          <ng-container matColumnDef="actions">
            ...
            <td mat-cell *matCellDef="let row">
              ...
              <button mat-icon-button disabled title="Requirements"><mat-icon>tune</mat-icon></button>
          ...
          <tr *matNoDataRow>
            <td [attr.colspan]="cols.length" class="no-data">No scholarships yet.</td>
          </tr>
        </table>
      </mat-card>
    </div>
...
export class OrgScholarshipsComponent {
