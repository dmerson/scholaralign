...
@Component({
  selector: 'app-public-applications',
  imports: [RouterLink, MatTableModule, MatButtonModule, MatIconModule, MatCardModule,
            MatBadgeModule, MatDialogModule, MatSnackBarModule, MatProgressSpinnerModule],
  template: `
    <div class="page">
          ...
          <table mat-table [dataSource]="apps()" class="full-width">
            ...
            <ng-container matColumnDef="questions">
              ...
              <td mat-cell *matCellDef="let row">
                <a mat-button [routerLink]="['/public-admin/applications', row.applicationId, 'questions']"
                   class="q-link">
...
export class PublicApplicationsComponent implements OnInit {
